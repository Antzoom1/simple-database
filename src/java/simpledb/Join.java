    ...
    protected Tuple fetchNext() throws TransactionAbortedException, DbException {
        ...
        while (true) {
            ...
            while (child2.hasNext()) {
                tuple2 = child2.next();
                // if the join predicate works for the 2 tuples, then we can
                // combine the tuples and iterate through them.
                if (p.filter(tuple1, tuple2)) {
                    ...
                    while(field1.hasNext()) {
                        combinedTuple.setField(counter++, field1.next());
                    }
                    while(field2.hasNext()) {
                        combinedTuple.setField(counter++, field2.next());
                    }
